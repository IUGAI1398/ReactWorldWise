  ...
  function o() {
    ...
    return ye(ke(t4 = n.call.apply(n, [this].concat(s3))), "MONTH_REFS", Se(Array(12)).map(function() {
      ...
      if ("Tab" !== d3 && e3.preventDefault(), !s4) {
        var u2 = Kt(p, i3), h3 = At[u2].verticalNavigationOffset, m3 = At[u2].grid;
        switch (d3) {
          case "Enter":
...
var Qt = function(t3) {
  ...
  function n() {
    ...
    return ye(ke(t4 = r2.call.apply(r2, [this].concat(a3))), "state", { height: null }), ye(ke(t4), "handleClick", function(e3) {
      ...
      return t4.isSelectedTime(e3) && r3.push("react-datepicker__time-list-item--selected"), ((t4.props.minTime || t4.props.maxTime) && lt(e3, t4.props) || (t4.props.excludeTimes || t4.props.includeTimes || t4.props.filterTime) && ct(e3, t4.props)) && r3.push("react-datepicker__time-list-item--disabled"), t4.props.injectTimes && (60 * getHours(e3) + getMinutes(e3)) % t4.props.intervals != 0 && r3.push("react-datepicker__time-list-item--injected"), r3.join(" ");
      ...
      return r3.map(function(r4, o3) {
        ...
        }, tabIndex: r4 === m3 ? 0 : -1, role: "option", "aria-selected": t4.isSelectedTime(r4) ? "true" : void 0 }, Ie(r4, n2, t4.props.locale));
      });
    }), t4;
  }
...
var er = function(t3) {
  ...
  function s3(t4) {
    ...
    return he(this, s3), ye(ke(i2 = a3.call(this, t4)), "getPreSelection", function() {
      ...
      if (i2.setState({ preventFocus: true }, function() {
        return i2.preventFocusTimeout = setTimeout(function() {
          return i2.setState({ preventFocus: false });
        }, 50), i2.preventFocusTimeout;
      }), i2.props.onChangeRaw && i2.props.onChangeRaw(t5), i2.setSelected(e3, t5, false, r2), i2.props.showDateSelect && i2.setState({ isRenderAriaLiveMessage: true }), !i2.props.shouldCloseOnSelect || i2.props.showTimeSelect)
      ...
      i2.setState({ preSelection: r2 }), i2.props.onChange(r2), i2.props.shouldCloseOnSelect && i2.setOpen(false), i2.props.showTimeInput && i2.setOpen(true), (i2.props.showTimeSelectOnly || i2.props.showTimeSelect) && i2.setState({ isRenderAriaLiveMessage: true }), i2.setState({ inputValue: null });
      ...
      if (i2.state.open || i2.props.inline || i2.props.preventOpenOnFocus) {
        if (i2.state.open) {
          ...
          "Enter" === t5 ? (e3.preventDefault(), i2.inputOk() && i2.state.lastPreSelectChange === rr ? (i2.handleSelect(n, e3), !i2.props.shouldCloseOnSelect && i2.setPreSelection(n)) : i2.setOpen(false)) : "Escape" === t5 ? (e3.preventDefault(), i2.setOpen(false)) : "Tab" === t5 && i2.setOpen(false), i2.inputOk() || i2.props.onInputError({ code: 1, msg: Zt });
        }
      } else
      ...
      e3 && e3.preventDefault && e3.preventDefault(), i2.props.selectsRange ? i2.props.onChange([null, null], e3) : i2.props.onChange(null, e3), i2.setState({ inputValue: null });
    ...
    }), i2.state = i2.calcInitialState(), i2;
  }
